    ...
    <modal name="new-project-modal" classes="p-10 bg-card rounded-lg" height="auto">
        ...
        <form @submit.prevent="submit">
                ...
                <div class="flex-1 mr-4">
                    <div class="mb-4">
                        ...
                        <input type="text"
                               ...
                               v-model="form.title">
                        <span class="text-xs text-italic text-error" v-if="errors.title"
                    ...
                    <div class="mb-4">
                        ...
                        <span class="text-xs text-italic text-error" v-if="errors.description"
            ...
            <footer class="flex justify-end">
                <button class="button is-outlined mr-2" @click="$modal.hide('new-project-modal')">Cancel</button>
